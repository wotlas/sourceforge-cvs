...
public class ItemType implements BackupReady {
    ...
    */
    ...
    static public final String[] itemType = { "miscelaneus", "potion", "scroll", "wand", "staff", "weapon", "armor", "container", "liquid container", "food", "key", "pen", "paper", "book", "money", "light", "bow", "ammo", "treasure", "trap", "fountain" };

    public ItemType(int type) {
        this.id = type;
        this.maskItemType = new int[1];
        this.defaultTileSet = new byte[1];
        this.defaultTileSetImageNr = new byte[1];
    }
    ...
    */
    ...
    public void writeExternal(java.io.ObjectOutput objectOutput) throws java.io.IOException {
        ...
        objectOutput.writeObject(this.maskItemPosition);
        objectOutput.writeObject(this.maskItemType);
        objectOutput.writeObject(this.defaultTileSet);
        objectOutput.writeObject(this.defaultTileSetImageNr);
    }
    ...
    public void readExternal(java.io.ObjectInput objectInput) throws java.io.IOException, java.lang.ClassNotFoundException {
        ...
        if (IdTmp == ExternalizeGetVersion()) {
            ...
            this.maskItemPosition = (int[]) objectInput.readObject();
            this.maskItemType = (int[]) objectInput.readObject();
            this.defaultTileSet = (byte[]) objectInput.readObject();
            this.defaultTileSetImageNr = (byte[]) objectInput.readObject();
        } else {
