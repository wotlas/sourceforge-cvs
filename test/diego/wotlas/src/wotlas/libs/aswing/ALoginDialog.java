 ...
 /*------------------------------------------------------------------------------------*/
   ...
   public ALoginDialog(Frame frame, String message, String defaultLogin, ASwingResourceLocator rLocator ) {
      ...
      // Fields
         ...
         f_login = new ATextField(defaultLogin);
         f_login.setBackground(new Color(235,235,235));
         fieldsPanel.add(f_login);

         ALabel l2 = new ALabel("Password :");
         l2.setBackground(Color.white);
         fieldsPanel.add(l2);

         f_password = new APasswordField(10);
         f_password.setBackground(new Color(235,235,235));
         fieldsPanel.add(f_password);
         ...
         buttonPanel.add( b_ok );
          ...
          b_ok.addActionListener(new ActionListener(){
              public void actionPerformed (ActionEvent e) {
                   login = f_login.getText();
                   password = new String( f_password.getPassword() );
