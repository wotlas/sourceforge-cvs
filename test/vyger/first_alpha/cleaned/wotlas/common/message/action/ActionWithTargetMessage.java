...
public abstract class ActionWithTargetMessage extends NetMessage {
     ...
     */
    public ActionWithTargetMessage() {
        super();
    }

    public ActionWithTargetMessage(int idOfAction, String targetKey, byte targetRange) {
        super();
    ...
    */
    ...
    public void encode(DataOutputStream ostream) throws IOException {
        ...
        ostream.writeUTF(this.targetKey);
    ...
    */
    ...
    public void decode(DataInputStream istream) throws IOException {
        ...
        this.targetKey = istream.readUTF();
