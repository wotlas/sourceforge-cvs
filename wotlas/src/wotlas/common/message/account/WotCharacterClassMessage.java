...
/** 
 * To set the account's wotcharacter (Message Sent by Client).
 *
 * @author Aldiss
 */

public class WotCharacterClassMessage extends NetMessage
{
 /*------------------------------------------------------------------------------------*/
  ...
  /** WotCharacter status ( rank in the Wot class of character )
   */
      protected byte wotCharacterStatus;
 ...
 /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  /** Constructor with the client's wot character className and status (see for example
   *  the AesSedai aesSedaiStatus ).
   *
