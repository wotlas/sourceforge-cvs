...
/** 
 * To write a message in a ChatRoom. (Message sent by Client)
 *
 * @author Petrus
 */

public class SendPublicTxtMessage extends NetMessage
{
 ...
 /*------------------------------------------------------------------------------------*/
   ...
   */
  public SendPublicTxtMessage() {
    super( MessageRegistry.CHAT_CATEGORY,
           ChatMessageCategory.SEND_PUBLIC_TXT_MSG );        
  }
  
  /** Constructor with parameters.
   */
  public SendPublicTxtMessage(String chatRoomPrimaryKey, String message) {
    this();
