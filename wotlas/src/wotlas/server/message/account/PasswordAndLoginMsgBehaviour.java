...
/**
 * Associated behaviour to the PasswordAndLoginMessage...
 *
 * @author Aldiss
 */

public class PasswordAndLoginMsgBehaviour extends PasswordAndLoginMessage implements NetMessageBehaviour
{
 /*------------------------------------------------------------------------------------*/

  /** Constructor.
   */
     public PasswordAndLoginMsgBehaviour() {
          super();
     }
   ...
   */
     public void doBehaviour( Object context ) {
        ...
        // the context is here an AccountBuilder
           ...
           builder.setLoginAndPassword( login, password );
     }
