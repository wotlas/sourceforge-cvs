 ...
 /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
    ...
    */
     static public String[] getInterfaceNames() {
       try{
         String names[] = new String[ getInterfaceNumber() ];
 ...
 /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
    ...
    */
     public static String[] getInterfaceAddresses( String itfName ) {
       ...
       try{
         String names[] = new String[ getAddressesNumber(itfName) ];
 ...
 /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
    ...
    */
     public static String getNetworkInfo() {
        String itf[] = getInterfaceNames();
        StringBuffer buf = new StringBuffer("Network Interfaces\n------------------\n\n");

        for( int i=0; i<itf.length; i++ ) {
             buf.append("  "+i+" - "+itf[i]+"\n");
             buf.append("      Descr. : "+getInterfaceDescription( itf[i] )+"\n" );
             buf.append("      IP adr : \n");
             
             String ip[] = getInterfaceAddresses( itf[i] );
