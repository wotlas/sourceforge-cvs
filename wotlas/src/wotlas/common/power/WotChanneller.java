...
{ 
    ...
    /** Test if the True Power is available
     *
     * @return success status
     */
    public boolean isTruePowerAvailable();

    /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/

    /** Toggle whether or not the True Power is in use, or the One Power
     *
     * @return the status of the True Power, true=in use
     */
    public boolean toggleTruePower();
