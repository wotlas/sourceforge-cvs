...
public class Plasma extends Spell {
    ...
    public void CastToTarget(CharData caster, CharData target) {
        ...
        SpellOnTheScreen eff = new ArrowSpell(effectNr
        ,caster.getScreenObject().getX(),caster.getScreenObject().getY()
        ,map.getMessageRouter()
        ,target.getScreenObject().getX(),target.getScreenObject().getY());
