...
import wotlas.common.screenobject.AreaSpell;
...
public class MultiGroupMessageRouterForTileMap extends MessageRouter {
    ...
    */
    ...
    public void init(WotlasLocation location, WorldManager wManager) {
        ...
        this.thisTileMap = wManager.getTileMap(location);

        if (this.thisTileMap == null) {
    ...
    */
    protected void updateChatInformation(PlayerImpl player) {
        ...
        msg.SetToUseScreenObjects(ChatRoom.DEFAULT_CHAT, this.players);
    ...
    public boolean removeScreenObject(ScreenObject item) {
        ...
        sendMessage(new RemoveScreenObjectFromTileMapMessage(item.getPrimaryKey(), this.thisTileMap.getLocation()), null, MessageRouter.EXTENDED_GROUP);
        ...
        if (item instanceof PlayerOnTheScreen) {
            ...
            if (!p.getCurrentChatPrimaryKey().equals(ChatRoom.DEFAULT_CHAT)) {
                RemPlayerFromChatRoomMsgBehaviour remPlayerFromChat = new RemPlayerFromChatRoomMsgBehaviour(player.getPrimaryKey(), p.getCurrentChatPrimaryKey());
    ...
    */
    ...
    public boolean addScreenObject(ScreenObject item) {
        ...
        item.setLocation(this.thisTileMap.getLocation()); // update player location
        item.serverInit(this.thisTileMap.getAStar());
        ...
        if (item instanceof PlayerOnTheScreen) {
            ...
            p.sendMessage(new TileMapPlayerDataMessage(this.thisTileMap, p));
