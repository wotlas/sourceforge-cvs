    ...
    */
    public void doBehaviour(Object sessionContext) {
        ...
        if (player.getLocation().isTileMap()) {
            ...
            synchronized (items) {
                itemToUpdate = (ScreenObject) items.get(this.primaryKey);
            }

            if (itemToUpdate != null && itemToUpdate.getPrimaryKey().equals(this.primaryKey)) {
                // if (DataManager.SHOW_DEBUG)
                ...
                itemToUpdate.getMovementComposer().setUpdate(this);
                return; // success !
            } else {
                if (DataManager.SHOW_DEBUG)
        ...
        System.out.println("Movement NOOOT updated for " + this.primaryKey + " I've DONE NOTHING!");
    }
