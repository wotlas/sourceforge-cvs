...
/**
 * The class of paragraphs. Used in chapters in books.
 * 
 * @author Elann
...
class Paragraph {
    ...
    /*------------------------------------------------------------------------------------*/
    /**
     * The actual text of the paragraph. HTML format.
     */
    private String text;
    /**
     ...
     * 
     * @param text
     *            the new HTML-formatted text of the paragraph
     */
     ...
     * 
     * @param style
     *            the new strike out style
     */
    public void setStrikeOutStyle(short style) {
        this.strikeOutStyle = style;
    }
