 ...
 * @author Diego
 */
public class BasicActionWithTargetMsgBehaviour extends BasicActionWithTargetMessage implements NetMessageBehaviour {

    /*------------------------------------------------------------------------------------*/

    /** Constructor.
    */
    public BasicActionWithTargetMsgBehaviour() {
        super();
    }
    ...
    */
    public void doBehaviour(Object sessionContext) {
        ...
        // let's try to cast
        if (BasicAction.getBasicAction(this.idOfAction).CanExecute(targetType, this.targetRange)) {
            if (targetType == UserAction.TARGET_TYPE_SELF) {
                BasicAction.getBasicAction(this.idOfAction).ExecuteToSelf(caster.getBasicChar());
            } else
                BasicAction.getBasicAction(this.idOfAction).ExecuteToTarget(caster.getBasicChar(), target.getCharData());
        } else
