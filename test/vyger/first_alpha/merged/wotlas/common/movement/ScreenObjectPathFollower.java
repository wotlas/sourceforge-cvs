    ...
    public synchronized void setUpdate(MovementUpdateMessage updateMessage) {
        ...
        */
        ...
        if (!AStarDouble.isInitialized()) {
            ...
            System.out.print("stage one " + this.walkingAlongPath + ": " + debugThis(this.xPosition) + "," + debugThis(this.yPosition));
            if (this.walkingAlongPath)
                System.out.print(" end " + debugThis(msg.dstPoint.x) + "," + debugThis(msg.dstPoint.y));
            System.out.println("");
        }
    }
    ...
    private synchronized void updatePathMovement() {
        ...
        if (this.turningAlongPath) {
            ...
            if (deltaA <= 0) {
                ...
                this.turningAlongPath = false;
                this.orientationAngle = ScreenObjectPathFollower.angle(getPosition(), this.nextPoint);
        ...
        float deltaD = ScreenObjectPathFollower.distance(getPosition(), this.prevPoint) - ScreenObjectPathFollower.distance(this.nextPoint, this.prevPoint);
    ...
    */
    ...
    synchronized public void initMovement(List path, int deltaTime) {
        ...
        for (int i = 0; i < path.size() - 1; i++) {
            ...
            d += ScreenObjectPathFollower.distance(a0, a1);
            ...
            if (d >= totalDistance) {
                ...
                this.orientationAngle = ScreenObjectPathFollower.angle(a0, a1);
    ...
    private void updateAngularNode() {
        this.nextAngle = ScreenObjectPathFollower.angle(this.prevPoint, this.nextPoint);
