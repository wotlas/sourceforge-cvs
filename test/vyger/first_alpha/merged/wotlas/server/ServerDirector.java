...
public class ServerDirector implements Runnable, NetServerListener {
    ...
    */
    ...
    /**  our defult Action Manager
    * actually manages only tilemaps, in the future even rooms
    */
    ...
    */
    public static void main(String argv[]) {
        ...
        try {
            ServerDirector.interp = new PythonInterpreter();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    /** To get our action manager.
     *  @return our action manager.
     */
    public static ActionManager getActionManager() {
        return ServerDirector.actionManager;
    }
