...
/** 
 * To write a message in a ChatRoom. (Message sent by Server)
 *
 * @author Petrus
 */

public class ReceivePublicTxtMessage extends NetMessage
{
 ...
 /*------------------------------------------------------------------------------------*/
   ...
   */
  public ReceivePublicTxtMessage() {
    super( MessageRegistry.CHAT_CATEGORY,
           ChatMessageCategory.RECEIVE_PUBLIC_TXT_MSG );        
  }
  
  /** Constructor with parameters.
   */
  public ReceivePublicTxtMessage(String chatRoomPrimaryKey, String senderPrimaryKey, String message) {
    this();
