...
// FIXME ???                  findPath( getPosition(), msg.dstPoint, screenObject.getLocation().isTileMap() )==null )
             ...
             // Our update...
                ...
                System.out.print( "stage one "+walkingAlongPath+": "
                +debugThis(xPosition)+","+debugThis(yPosition) );
                if( walkingAlongPath )
                    System.out.print( " end "
                    +debugThis(msg.dstPoint.x)+","+debugThis(msg.dstPoint.y) );
                System.out.println( "" );
           }
     }
