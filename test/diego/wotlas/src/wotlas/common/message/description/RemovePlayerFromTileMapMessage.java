...
public class RemovePlayerFromTileMapMessage extends NetMessage {
 ...
 /*------------------------------------------------------------------------------------*/
   ...
   */
     public RemovePlayerFromTileMapMessage() {
          super();
     }
 ...
 /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
   ...
   */
     public RemovePlayerFromTileMapMessage(String primaryKey, WotlasLocation location) {
          super();
