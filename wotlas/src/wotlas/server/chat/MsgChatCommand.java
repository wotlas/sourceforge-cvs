...
public class MsgChatCommand implements ChatCommand {
    ...
    public String getCommandDocumentation() {
        return "<font size='4'>Command 'msg'</font>" + "<br><b> Syntax :</b> /msg [playerKey] [message] " + "<br><b> Voice  :</b> normal voice level " + "<br><b> Descr  :</b> sends the given message to a player." + "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Use the /who command to find the player key." + "<br><b> Example:</b> /msg alice-1-34 hello alice !";
    }
