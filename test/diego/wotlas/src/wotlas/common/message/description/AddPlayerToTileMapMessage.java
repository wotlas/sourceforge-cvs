...
public class AddPlayerToTileMapMessage extends PlayerDataMessage
{
 /*------------------------------------------------------------------------------------*/

  /** Constructor. Just initializes the message category and type.
   */
     public AddPlayerToTileMapMessage() {
          super();
     }
 ...
 /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
   ...
   */
     public AddPlayerToTileMapMessage( Player otherPlayer, Player player ) {
         this();
