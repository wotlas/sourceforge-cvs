 ...
 * sub-directories in the disk space that represents the Image library (where
 * the images are stored).
 * 
 * For example if the image library contains a directory "animals-0/cats-0-jit/"
 * that have 'cat-0.jpg', 'cat-1.jpg' and 'cat-2.gif' images, the following
 * ImageIdentifier :<br>
 * 
 * <pre>
 ...
 * 
 * <br>
 * will always represent the first image of the "cats-0" directory, i.e.
 * 'cats-0.jpg'. Note that directory options are optional here ( the directory
 * name was "cats-0-jit", but we gave "cats-0").<br>
 * 
 ...
 * 
 * <br>
 * will represent the specified image "cats-1.jpg" of the "cat" directory. The
 * extension ".jpg" is mandatory.<br>
 * 
 * This other ImageIdentifier :
 * 
 * <pre>
 ...
 * 
 * <p>
 * will represent the image "cat-0.jpg" of the "cat" directory, but will also
 * tell that this ImageIdentifier is an animation. This means that all the
 * images of the "cat" directory are the images of a same animation. For
 * example, if you then give this ImageIdentifier to a MotionlessSprite (
 * Drawable object ) it will create an Animation object to change the current
 * image at each application tick(). We'll start with 'cat-0.jpg' then continue
 * with 'cat-1.jpg', 'cat-2.gif', 'cat-0.jpg', etc...
 * </p>
 * 
 * <p>
 * <b>Important</b> : When you create an ImageIdentifier you give "String"
 * objects as arguments. These strings are not kept in memory, they are replaced
 * by an internal integer representation. Thus once created an ImageIdentifier
 * represents directly a valid entry of the ImageLibrary.
 * </p>
 * 
 * <p>
 * To create an ImageIdentifier we don't need the ImageLibrary : from a "<name>-<number>"
 * directory name or <name>-<number>.<jpg|gif> image name we retrieve the
 * <number> part. For more examples take a look at the ImageLibrary.
 * </p>
 * 
 * 
