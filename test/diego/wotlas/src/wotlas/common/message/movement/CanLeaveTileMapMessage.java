...
public class CanLeaveTileMapMessage extends LocationChangeMessage
{
 /*------------------------------------------------------------------------------------*/

  /** Constructor. Just initializes the message category and type.
   */
     public CanLeaveTileMapMessage() {
          super();
     }
 ...
 /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
   ...
   */
     public CanLeaveTileMapMessage(String primaryKey, WotlasLocation location, int x, int y, float orientation) {
          super();
 ...
 /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
   ...
   */
     public CanLeaveTileMapMessage( LocationChangeMessage msg ) {
          super();
