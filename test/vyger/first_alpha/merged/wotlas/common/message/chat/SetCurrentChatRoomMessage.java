    ...
    */
    ...
    public void SetToUseScreenObjects(String chatRoomPrimaryKey, Hashtable screenObjects) {
        ...
        synchronized (screenObjects) {
            ...
            this.playersPrimaryKey = new String[oTmp1.length];
            this.fullPlayerNames = new String[oTmp2.length];
            for (int i = 0; i < oTmp1.length; i++) {
                this.playersPrimaryKey[i] = (String) oTmp1[i];
                this.fullPlayerNames[i] = (String) oTmp2[i];
            }
        }
    }
