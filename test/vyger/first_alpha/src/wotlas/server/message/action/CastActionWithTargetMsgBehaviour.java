    ...
    public void doBehaviour( Object sessionContext ) {
        ...
        if( CastAction.getCastAction(idOfAction).CanExecute( targetType, targetRange ) ) {
            if( targetType == UserAction.TARGET_TYPE_SELF ) {
                CastAction.getCastAction(idOfAction).ExecuteToSelf( caster.getBasicChar() );
            } else 
                CastAction.getCastAction(idOfAction).ExecuteToTarget( caster.getBasicChar(), target.getCharData() );
        }
        else
