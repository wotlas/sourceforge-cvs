...
public class ScheduleTime implements BackupReady {
    ...
    */
    ...
    public void writeExternal(java.io.ObjectOutput objectOutput) throws java.io.IOException {
        ...
        objectOutput.writeBoolean(this.isEnvironmentTime);
        objectOutput.writeShort(this.minutesTimeBegin);
        objectOutput.writeShort(this.minutesTimeDuration);
    }
    ...
    public void readExternal(java.io.ObjectInput objectInput) throws java.io.IOException, java.lang.ClassNotFoundException {
        ...
        if (IdTmp == ExternalizeGetVersion()) {
            this.isEnvironmentTime = objectInput.readBoolean();
            this.minutesTimeBegin = objectInput.readShort();
            this.minutesTimeDuration = objectInput.readShort();
        } else {
