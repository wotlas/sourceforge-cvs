...
import wotlas.server.LieMemory;
import wotlas.server.LieMemoryIterator;
...
public class LieChatCommand implements ChatCommand {
    ...
    public String getCommandDocumentation() {
        return "<font size='4'>Command 'lie'</font>" + "<br><b> Syntax :</b> /lie [playerKey] " + "<br><b> Voice  :</b> normal voice level " + "<br><b> Descr  :</b> returns informations on player's fake names." + "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Use the /who command to find the player key." + "<br><b> Example:</b> /lie alice-1-34";
    }
