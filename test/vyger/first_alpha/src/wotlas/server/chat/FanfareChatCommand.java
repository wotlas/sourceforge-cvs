 ...
 /*------------------------------------------------------------------------------------*/
    ...
    */
      public String getCommandDocumentation() {
      	return "<font size='4'> Command 'fanfare'</font>" +
      	       "<br><b> Syntax :</b> /fanfare " +
      	       "<br><b> Voice  :</b> normal voice level " +
      	       "<br><b> Descr  :</b> plays trumpet to really draw attention to you." +
      	       "<br><b> Example:</b> none.";
      }
    ...
    */
      public boolean exec( String message, PlayerImpl player, SendTextMessage response ) {
       ...
       // So that the sound command is sent to everybody near
          response.setMessage( "/fanfare "+player.getBasicChar().getFanfareSound() );
