...
/** 
 * This is the class for Asha'man's Inventory.<br>
 * All objects are inherited. All methods are inherited excepted those not available to Asha'man.
 * @author Elann
 * @see wotlas.common.objects.interfaces.InventoryInterface
 */

public class AshamanInventory extends Inventory {
