...
public class PlayerImpl implements Player, SpriteDataSupplier, Tickable {
    ...
    public void init() {
        ...
        this.animation = new Animation(this.wotCharacter.getImage(this.location), ClientDirector.getDataManager().getImageLibrary());
    ...
    public void setLocation(WotlasLocation myLocation) {
        ...
        if (this.location.isRoom())
            this.myRoom = ClientDirector.getDataManager().getWorldManager().getRoom(this.location);
        else
            this.myRoom = null;
    }
    ...
    public String getPlayerPast() {
        if (this.playerPast == null) {
            ...
            sendMessage(new PlayerPastMessage(this.primaryKey, ""));
    ...
    public String getPlayerAwayMessage() {
        ...
        if (this.playerAwayMessage == null)
            sendMessage(new PlayerAwayMessage(this.primaryKey, ""));
    ...
    public Drawable getTextDrawable() {
        ...
        if (this.isConnectedToGame) {
            this.textDrawable = new TextDrawable(this.fullPlayerName, getDrawable(), this.wotCharacter.getColor(), 13.0f, "Lucida Blackletter Regular", ImageLibRef.TEXT_PRIORITY, 5000);
        } else {
            this.textDrawable = new TextDrawable(this.fullPlayerName + " (away)", getDrawable(), this.wotCharacter.getColor(), 13.0f, "Lucida Blackletter Regular", ImageLibRef.TEXT_PRIORITY, 5000);
        }
    ...
    public MultiLineText getGameScreenFullPlayerName() {
        if (this.gameScreenFullPlayerName == null) {
            ...
            this.gameScreenFullPlayerName = new MultiLineText(strTemp, 10, 10, Color.black, 15.0f, "Lucida Blackletter Regular", ImageLibRef.TEXT_PRIORITY, MultiLineText.LEFT_ALIGNMENT);
        }
