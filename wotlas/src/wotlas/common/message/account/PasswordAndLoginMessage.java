...
/** 
 * To set the account's password & login. (Message Sent by Client)
 *
 * @author Aldiss
 */

public class PasswordAndLoginMessage extends NetMessage
{
 /*------------------------------------------------------------------------------------*/
 ...
 /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
   ...
   */
     public PasswordAndLoginMessage( String login, String password ) {
         this();
         this.login = login;
