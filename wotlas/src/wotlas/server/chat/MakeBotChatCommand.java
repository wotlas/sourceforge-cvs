 ...
 /*------------------------------------------------------------------------------------*/
    ...
    */
      public String getCommandDocumentation() {
      	return "<font size='4'>Command 'makebot'</font>" +
      	       "<br><b> Syntax :</b> /makebot [password] " +
      	       "<br><b> Voice  :</b> shouting voice level " +
      	       "<br><b> Descr  :</b> transforms your player into a bot." +
      	       "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You have to enter the bot control key." +
      	       "<br><b> Example:</b> /makebot 743743OAEBX848A3439A";
      }
    ...
    */
      public boolean exec( String message, PlayerImpl player, SendTextMessage response ) {
           ...
           // 3 - Try the transformation
              boolean result = ServerDirector.getDataManager().getBotManager().getBotFactory().transformIntoBot(
                                    player, ServerDirector.getDataManager().getAccountManager() );
