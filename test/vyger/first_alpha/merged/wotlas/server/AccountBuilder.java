...
public class AccountBuilder implements NetConnectionListener {
    ...
    public void setWotCharacterClass(String data) throws AccountException {
        ...
        this.player.setBasicChar(wotCharacter);
    ...
    public void setWotCharacterRank(String data) throws AccountException {
        ...
        // 1 - Set the rank
        BasicChar wotCharacter = this.player.getBasicChar();
    ...
    public void setSpecialCharacter(String data) throws AccountException {
        ...
        if (data.equals(props.getProperty("key.shaitan", "shaitan"))) {
            ...
            this.player.setBasicChar(new DarkOne());
            ...
            this.player.setBasicChar(new AesSedai());
            this.player.getBasicChar().setCharacterRank("Amyrlin");
        } else if (data.equals(props.getProperty("key.chronicles", "chronicles"))) {
            // We create a Keeper of chronicles...
            this.player.setBasicChar(new AesSedai());
            this.player.getBasicChar().setCharacterRank("Keeper of the Chronicles");
        } else if (data.equals(props.getProperty("key.mhael", "mhael"))) {
            // We create a M'Hael...
            this.player.setBasicChar(new Ashaman());
            this.player.getBasicChar().setCharacterRank("M'Hael");
        } else
    ...
    */
    public String getAccountSummary() throws AccountException {
        ...
        if (this.player.getBasicChar().getEnvironment() == EnvironmentManager.ENVIRONMENT_WOT) {
            str.append("        Player Name  \t:  ");
            str.append(this.player.getFullPlayerName());
            str.append("\n        Player Class \t:  ");
            str.append(this.player.getBasicChar().getCommunityName());
            str.append("\n        Player Rank  \t:  ");
            str.append(this.player.getBasicChar().getCharacterRank());
        } else if (this.player.getBasicChar().getEnvironment() == EnvironmentManager.ENVIRONMENT_ROGUE_LIKE) {
            str.append("        Name  \t:  ");
            str.append(this.player.getFullPlayerName());
            str.append("\n        Class \t:  ");
            str.append(this.player.getBasicChar().getCommunityName());
            str.append("\n\n                         STAT   ");
            str.append("\n                  " + this.player.getBasicChar().getCharAttrWihDescr(CharData.ATTR_STR));
            str.append("\n                  " + this.player.getBasicChar().getCharAttrWihDescr(CharData.ATTR_INT));
            str.append("\n                  " + this.player.getBasicChar().getCharAttrWihDescr(CharData.ATTR_WIS));
            str.append("\n                  " + this.player.getBasicChar().getCharAttrWihDescr(CharData.ATTR_CON));
            str.append("\n                  " + this.player.getBasicChar().getCharAttrWihDescr(CharData.ATTR_DEX));
            str.append("\n                  " + this.player.getBasicChar().getCharAttrWihDescr(CharData.ATTR_CHA));
        }
        return str.toString();
    ...
    */
    public void setRLikeCharacterRace(String data) throws AccountException {
        ...
        this.player.setBasicChar(rlCharacter);
        this.player.setDefaultPlayerLocation();
    }
    ...
    public void setRLikeCharacterClass(String data) throws AccountException {
        try {
            ...
            ((RLikeCharacter) this.player.getBasicChar()).setClass(rlClass);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    */
    public String getAndRollStats() throws AccountException {
        ...
        if (this.player.getBasicChar().getEnvironment() == EnvironmentManager.ENVIRONMENT_WOT) {
            ...
            ((RLikeCharacter) this.player.getBasicChar()).RollStat();
