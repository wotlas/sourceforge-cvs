...
public class Warrior extends RLikeClass {
    ...
    public void RollStat() {
        ...
        this.myChar.setCharAttr(CharData.ATTR_STR, stats[0]);
        this.myChar.setCharAttr(CharData.ATTR_INT, stats[4]);
        this.myChar.setCharAttr(CharData.ATTR_WIS, stats[5]);
        this.myChar.setCharAttr(CharData.ATTR_CON, stats[1]);
        this.myChar.setCharAttr(CharData.ATTR_DEX, stats[2]);
        this.myChar.setCharAttr(CharData.ATTR_CHA, stats[3]);
