...
public class ServerAddressSetup extends JWizard {
    ...
    public ServerAddressSetup() {
        super("Server Address Setup", ServerDirector.getResourceManager(), ServerDirector.getResourceManager().getGameDefinition(), FontFactory.getDefaultFontFactory().getFont("Lucida Blackletter Regular").deriveFont(18f), 470, 550);
