    ...
    public void doBehaviour( Object sessionContext ) {
        ...
        if( BasicAction.getBasicAction(idOfAction).CanExecute( targetType, targetRange ) ) {
            if( targetType == UserAction.TARGET_TYPE_SELF ) {
                BasicAction.getBasicAction(idOfAction).ExecuteToSelf( caster.getBasicChar() );
            } else 
                BasicAction.getBasicAction(idOfAction).ExecuteToTarget( caster.getBasicChar(), target.getCharData() );
        }
        else
