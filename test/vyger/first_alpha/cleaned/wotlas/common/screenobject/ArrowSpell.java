 ...
 * @author Diego
 */
public class ArrowSpell extends SpellOnTheScreen {
    ...
    public ArrowSpell(int imageNr, int x, int y, MessageRouter routerMsg, int endX, int endY) {
    ...
    */
    ...
    public void init(GraphicsDirector gDirector) {
        ...
        //System.out.println("Spell-> x,y:["+x+","+y+"] to x,y:["+endX+","+endY+"] ");
    }
