...
public abstract class PreloaderEnabled extends ScreenRectangle implements BackupReady, SendObjectReady {
    ...
    public void writeExternal(java.io.ObjectOutput objectOutput) throws java.io.IOException {
        ...
        objectOutput.writeObject(this.approved);
        objectOutput.writeObject(this.lastChange);
        objectOutput.writeBoolean(this.reserved);
    }
    ...
    public void readExternal(java.io.ObjectInput objectInput) throws java.io.IOException, java.lang.ClassNotFoundException {
        ...
        if (IdTmp == ExternalizeGetVersion()) {
            ...
            this.creator = (String) objectInput.readObject();
            this.approved = (String) objectInput.readObject();
            this.lastChange = (String) objectInput.readObject();
            this.reserved = objectInput.readBoolean();
        } else {
    ...
    static public void SetClassPreloader(byte value) {
        PreloaderEnabled.setClassPreloader = value;
    }
    ...
    static public void Reload(ResourceManager rManager, WorldManager worldMan, TileMap previousData, byte status) {
        PreloaderEnabled.SetClassPreloader(status);
        ...
        System.out.println("id " + data[previousData.tileMapID].tileMapID + " loc " + data[previousData.tileMapID].getLocation());
    }
}