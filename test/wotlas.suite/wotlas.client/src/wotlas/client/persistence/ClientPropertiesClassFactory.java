 ...
 */
package wotlas.client.persistence;
 ...
 * @author SleepingOwl
 */
public class ClientPropertiesClassFactory implements WishPropertiesClassFactory {

    public Class propertyClassForName(String className) throws PersistenceException {
        if (className == null || !className.startsWith("wotlas.client")) {
            return null;
        }
