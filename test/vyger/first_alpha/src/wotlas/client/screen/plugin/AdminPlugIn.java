...
public class AdminPlugIn extends JPanelPlugIn  {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        summDwarfKing = new javax.swing.JButton();
        summDwarfCleric = new javax.swing.JButton();
        summDwarfWizard = new javax.swing.JButton();
        attackCommand = new javax.swing.JButton();
        plasmaBoltSpell = new javax.swing.JButton();
        moveHere = new javax.swing.JButton();
        ...
        summDwarfKing.setText("dwarf king");
        summDwarfKing.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                summDwarfKingActionPerformed(evt);
            }
        });

        jPanel1.add(summDwarfKing);
        summDwarfKing.setBounds(10, 70, 110, 20);

        summDwarfCleric.setText("dwarf cleric");
        summDwarfCleric.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                summDwarfClericActionPerformed(evt);
            }
        });

        jPanel1.add(summDwarfCleric);
        summDwarfCleric.setBounds(10, 90, 110, 20);

        summDwarfWizard.setText("dwarf wizard");
        summDwarfWizard.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                summDwarfWizardActionPerformed(evt);
            }
        });

        jPanel1.add(summDwarfWizard);
        summDwarfWizard.setBounds(10, 110, 110, 20);

        attackCommand.setText("attack");
        attackCommand.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                attackCommandActionPerformed(evt);
            }
        });

        jPanel1.add(attackCommand);
        attackCommand.setBounds(10, 140, 70, 20);

        plasmaBoltSpell.setText("Plasma bolt");
        plasmaBoltSpell.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                plasmaBoltSpellActionPerformed(evt);
            }
        });

        jPanel1.add(plasmaBoltSpell);
        plasmaBoltSpell.setBounds(10, 170, 101, 20);

        moveHere.setText("come Here!");
        moveHere.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                moveHereActionPerformed(evt);
            }
        });

        jPanel1.add(moveHere);
        moveHere.setBounds(10, 200, 99, 20);
