...
public class KillChatCommand implements ChatCommand {
    ...
    public String getCommandDocumentation() {
        return "<font size='4'>Command 'kill'</font>" + "<br><b> Syntax :</b> /kill [playerKey] " + "<br><b> Voice  :</b> shouting voice level " + "<br><b> Descr  :</b> kills the given player (of the same room)." + "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Only works if you are the dark one." + "<br><b> Example:</b> /kill asmodean-1-34";
    }
