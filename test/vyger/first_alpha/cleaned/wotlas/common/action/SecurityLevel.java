...
public class SecurityLevel {
    ...
    public boolean CheckSecurityLevel(SecurityLevel havingthis) {
        if (this.needed == SecurityLevel.PLAYER) // player needs can reached by all
            return true;
        else if (havingthis.needed == SecurityLevel.SYSOP) // sysop do all
            return true;
        else if (this.needed == SecurityLevel.BUILDER && havingthis.needed == SecurityLevel.BUILDER) // builder can do builder act
            return true;
        return false;
    }
